const drawTablePromo = async () => {
    ...
    try {
        ...
        if (Object.keys(response).length < 1) {
            let promoList = ` <tr> 
                          <td colspan="5">Sin Promciones</td>  
                      </tr>
                      `;
        ...
        alertify.error("Error : "+ error +"<br> No hay comunicación con el servidor" );
...
const editTablePromo = async (promoId) => {
    ...
    $("#alert-edit-promo").html(`<div class="alert alert-warning" role="alert">
